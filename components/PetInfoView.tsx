...
import { Text, Checkbox, Button, List, Divider, useTheme } from "react-native-paper";
    ...
    <ScrollView>
      <View style={styles.view}>
        ...
        <List.Section>
          ...
          <ProfileListItem
            title="Type"
            description={pet.petType.charAt(0).toUpperCase() + pet.petType.slice(1)}  // Capitalise first letter
            icon={() => <PawIcon height={25} width={25} fill={theme.colors.primary} />}
          />
          <Divider />
          <ProfileListItem
            title="Size" 
            description={pet.petSize.charAt(0).toUpperCase() + pet.petSize.slice(1)}  // Capitalise first letter
